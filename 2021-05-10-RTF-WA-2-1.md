...
<!--  -->
<!--  -->
In comparison to the last gamemode I looked at, the Classic Zombies gamemode starts with all of the humans on one team, these are all of the actual players in the round, and they have the goal to not get turned into zombies. If they do get turned into zombies, however, they get to go attack their teammates. There’s a similar structure of the best of however many rounds you choose, and buying being available at the beginning of each round, however managing the amount of money you have is not as big of a deal. Instead, primarily you choose a weapon kit you can define from the main menus. This game mode doesn’t really allow the zombies to win as a team all that often, as they don’t seem to have quite enough time to win out, but that’s not really the point of the gamemode. The main point of the gamemode is the victory of the individual for staying alive. 
<!--  -->
<!--  -->
</p>
<br>
<p style="line-height: 2; font-family: Times New Roman; font-size: 16px;">
1.3 A Few Other Important Gamemodes
</p>
<p style="line-height: 2; font-family: Times New Roman; font-size: 16px;">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
There are a couple other gamemodes that are popular here in the west I should probably give a brief overview of. There’s deathmatch, where it’s a free-for-all. Everyone gets to pick whatever weapons they want. Another honorable mention is the gungame gamemode, where it’s deathmatch, but you start at the bottom of a weapon progression chain and work your way up it, gaining progressively worse weapons as you progress. 
</p>
<br>
<p style="line-height: 2; font-family: Times New Roman; font-size: 16px;">
